...
Use the `cp` command to pull down the tarball file from this path: ``.  Now unpack it to your working directory.  Be sure to get help if you have trouble with this since future questions will require that you succeeded at this.
